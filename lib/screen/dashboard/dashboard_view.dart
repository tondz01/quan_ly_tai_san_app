...
class _DashboardViewState extends State<DashboardView> {
  ...
  Widget _buildStatisticsSection() {
    return GridView.count(
      ...
      children: [
        StatisticsCard(title: 'Tổng tài sản', value: '1,234', icon: Icons.inventory, color: ColorValue.primaryBlue, trend: '+12%', trendUp: true),
        StatisticsCard(title: 'Đang sử dụng', value: '987', icon: Icons.check_circle, color: ColorValue.success, trend: '+8%', trendUp: true),
        StatisticsCard(title: 'Bảo trì', value: '45', icon: Icons.build, color: ColorValue.warning, trend: '-3%', trendUp: false),
        StatisticsCard(title: 'Ngừng sử dụng', value: '23', icon: Icons.cancel, color: ColorValue.error, trend: '-5%', trendUp: false),
      ],
    );
  }
    ...
    return SingleChildScrollView(
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: ColorValue.neutral200.withOpacity(0.3), spreadRadius: 0, blurRadius: 8, offset: const Offset(0, 4))],
        ),
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.pie_chart, color: ColorValue.primaryBlue, size: 24),
                const SizedBox(width: 12),
                Text('Trạng thái tài sản', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: ColorValue.neutral900)),
              ],
            ),
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(label, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: ColorValue.neutral700)),
        ...
        Container(
          height: 8,
          decoration: BoxDecoration(color: ColorValue.neutral200, borderRadius: BorderRadius.circular(4)),
