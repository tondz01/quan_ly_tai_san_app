class StaffConstants {
  ...
  static const String errorPhoneFormat =
      'Số điện thoại không đúng định dạng (0xxxxxxxxx)';
  ...
  static const String errorPinRequired =
      'Vui lòng nhập mã PIN để lấy Agreement UUID';
  static const String errorFileTooLarge =
      'File quá lớn. Kích thước tối đa là 5MB';
  static const String errorFileReadFailed =
      'Không thể đọc file. Vui lòng chọn file khác.';
}
