      ...
      for (final table in decoder.tables.keys) {
        ...
        for (int rowIndex = 1; rowIndex <= rowsToProcess && rowIndex < sheet.maxRows; rowIndex++) {
          ...
          final json = <String, dynamic>{
            ...
            'soLuong': 1,
            'donViTinh': AppUtility.s(cellAt(28)),
            'ghiChu': AppUtility.s(cellAt(29)),
            'idDonViBanDau': AppUtility.s(cellAt(30)),
            'idDonViHienThoi': AppUtility.s(cellAt(31)),
            'moTa': AppUtility.s(cellAt(32)),
            'idCongTy': 'ct001',
            'ngayTao': AppUtility.normalizeDateIsoStringV2(cellAt(33)),
            'ngayCapNhat': AppUtility.normalizeDateIsoStringV2(cellAt(34)),
            'nguoiTao': AppUtility.s(cellAt(35), fallback: fallbackUser),
            'nguoiCapNhat': AppUtility.s(cellAt(36), fallback: fallbackUser),
            'isActive': true,
            'isTaiSanCon': false,
          };
