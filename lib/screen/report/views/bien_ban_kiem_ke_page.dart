...
class BodyBienBanKiemKe extends StatelessWidget {
  const BodyBienBanKiemKe({super.key, required this.inventoryMinutes, this.startIndex = 0});
  final List<InventoryMinutes> inventoryMinutes;
...
class FooterBienBanKiemKe extends StatelessWidget {
...
class HeaderBienBanKiemKe extends StatelessWidget {
