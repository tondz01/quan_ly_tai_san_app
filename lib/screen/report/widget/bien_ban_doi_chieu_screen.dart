...
class BienBanDoiChieuScreen extends StatefulWidget {
  ...
  const BienBanDoiChieuScreen({super.key, required this.idCongty});

  @override
  State<BienBanDoiChieuScreen> createState() => _BienBanDoiChieuScreenState();
}

class _BienBanDoiChieuScreenState extends State<BienBanDoiChieuScreen> {
