...
class ImprovedTablesDemo extends StatefulWidget {
  ...
  @override
  State<ImprovedTablesDemo> createState() => _ImprovedTablesDemoState();
}

class _ImprovedTablesDemoState extends State<ImprovedTablesDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Improved Tables Demo'),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Material Design với hiệu ứng đổ bóng đẹp mắt',
                          style: TextStyle(
                            fontSize: 14,
