...
class EnhancedTablesDemo extends StatefulWidget {
  const EnhancedTablesDemo({super.key});

  @override
  State<EnhancedTablesDemo> createState() => _EnhancedTablesDemoState();
}

class _EnhancedTablesDemoState extends State<EnhancedTablesDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Enhanced Tables Demo'),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Bảng dữ liệu đã được cải thiện',
                          style: TextStyle(
                            fontSize: 18,
                        ...
                        Text(
                          'Auto fill toàn bộ chiều ngang màn hình với đổ bóng và bo góc đẹp',
                          style: TextStyle(
                            fontSize: 14,
