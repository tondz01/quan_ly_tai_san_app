...
class ToolAndMaterialTransferDto {
  ...
  factory ToolAndMaterialTransferDto.fromJson(Map<String, dynamic> json) {
    ...
    return ToolAndMaterialTransferDto(
      ...
      tggnTuNgay: json['tggnTuNgay'] != null ? AppUtility.formatFromISOString(json['tggnTuNgay'] ?? '') : AppUtility.DATE_NULL,
      tggnDenNgay: json['tggnDenNgay'] != null ? AppUtility.formatFromISOString(json['tggnDenNgay'] ?? '') : AppUtility.DATE_NULL,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "tggnTuNgay": tggnDenNgay != null && tggnDenNgay!.isNotEmpty ? AppUtility.formatFromISOString(tggnTuNgay ?? '') : AppUtility.DATE_NULL,
      "tggnDenNgay": tggnDenNgay != null && tggnDenNgay!.isNotEmpty ? AppUtility.formatFromISOString(tggnDenNgay ?? '') : AppUtility.DATE_NULL,
      ...
      "share": share,
      "isActive": isActive,
      "chiTietToolAndMaterialTransfers":
          detailToolAndMaterialTransfers
              ?.map((detail) => detail.toJson())
              .toList(),
      "listSignatory":
          listSignatory?.map((signatory) => signatory.toJson()).toList(),
      "daBanGiao": daBanGiao,
      "byStep": byStep,
  ...
  factory ToolAndMaterialTransferDto.empty() {
    return ToolAndMaterialTransferDto(
      ...
      tggnTuNgay: AppUtility.formatFromISOString(
        DateTime.now().toIso8601String(),
      ),
      tggnDenNgay: AppUtility.formatFromISOString(
  ...
  ToolAndMaterialTransferDto copyWith({
    ...
    return ToolAndMaterialTransferDto(
      ...
      tggnTuNgay: AppUtility.formatFromISOString(
        tggnTuNgay ?? this.tggnTuNgay ?? '',
      ),
      tggnDenNgay: AppUtility.formatFromISOString(
        tggnDenNgay ?? this.tggnDenNgay ?? '',
      ),
      ...
      ngayKy: AppUtility.formatFromISOString(ngayKy ?? this.ngayKy ?? ''),
