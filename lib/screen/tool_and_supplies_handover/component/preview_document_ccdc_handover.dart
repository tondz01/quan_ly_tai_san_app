...
Widget previewDocumentCcdcDecisionHandover({
  required BuildContext context,
  ...
  return InkWell(
    onTap: () {
      ...
      prevDocumentCcdcDecisionHandover(context: context, document: document);
    },
    child: Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      mainAxisSize: MainAxisSize.min,
    ...
    builder:
        (context) => CommonContract(
          ...
          eventSignature: () {
            ...
            context.read<ToolAndSuppliesHandoverProvider>().onPushMessage(
              dieuDongCcdc,
            );
          },
        ),
...
prevDocumentCcdcDecisionHandover({
  required BuildContext context,
  PdfDocument? document,
}) {
  return showDialog(
