...
/// ReportPageWrapperMultipage - Component wrapper cho báo cáo có nội dung multi-page
/// Tương tự ReportPageWrapper nhưng content area không có padding mặc định
/// để chứa các RepaintBoundary + A4Canvas pages
class ReportPageWrapperMultipage extends StatelessWidget {
  /// Tiêu đề báo cáo
  final String title;
  ...
  /// Nội dung báo cáo (multi-page content)
  ...
  const ReportPageWrapperMultipage({
    super.key,
    required this.title,
