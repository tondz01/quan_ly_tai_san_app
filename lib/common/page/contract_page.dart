...
class ContractPage {
  ...
  static Widget assetHandoverPageV2(
    ...
    log("message check item ${jsonEncode(assetHandoverDto)}");
    // NhanVien getNhanVien({required String idNhanVien}) {
    //   if (listNhanVien == null) return NhanVien();
    //   final found = listNhanVien!.firstWhere(
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              for (int i = 0; i < (listSigneInfo?.length ?? 0); i++)
                SGText(
                  text:
                      "${i + 1}.    Ông (bà): ${listSigneInfo![i].hoTen}.....Chức vụ: ${listSigneInfo[i].chucVu}.....Đại diện: ${listSigneInfo[i].donVi}",
                  style: SettingPage.textStyle,
                ),
            ],
          ),
  ...
  static Widget assetMovePageV2(DieuDongTaiSanDto dieuDongTaiSanDto) {
    ...
    return Column(
      ...
      children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 1,
                      width:
                          70 * SettingPage.scale, // chỉnh độ dài của gạch ngang
                      color: Colors.black,
                    ),
                    SGText(
                      text: "Số: ${dieuDongTaiSanDto.soQuyetDinh ?? ''}",
                      style: SettingPage.textStyle,
                      textAlign: TextAlign.center,
                    ),
                  ],
              ...
              child: Align(
                ...
                child: Column(
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Container(
                          ...
                          width:
                              210 *
                              SettingPage.scale, // chỉnh độ dài của gạch ngang
                          color: Colors.black,
                        ),
                      ],
                    ),
                    ...
                    SGText(
                      text:
                          "Uông Bí,  ${SettingPage.formatted(dieuDongTaiSanDto.ngayTao ?? '')} ",
                      style: SettingPage.textStyle,
                      textAlign: TextAlign.center,
                    ),
                  ],
        ...
        Center(
          child: SGText(
            text: "Về việc $typeAssetTransfer",
            style: SettingPage.textStyle.copyWith(
              fontWeight: FontWeight.bold,
              fontSize: 14 * SettingPage.scale,
            ),
        ...
        Center(
          child: SGText(
            text: "GIÁM ĐỐC CÔNG TY THAN UÔNG BÍ - TKV",
            style: SettingPage.textStyle.copyWith(
              fontWeight: FontWeight.bold,
              fontSize: 14 * SettingPage.scale,
            ),
        ...
        SGText(
          text:
              "Tiến hành điều động tài sản tại  ${dieuDongTaiSanDto.tenDonViNhan ?? ''} cụ thể như sau:",
          style: SettingPage.textStyle,
        ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SGText(
                      text: "${dieuDongTaiSanDto.tenDonViNhan}",
                      style: SettingPage.textStyle.copyWith(
                        fontSize: 11 * SettingPage.scale,
                      ),
                    ),
